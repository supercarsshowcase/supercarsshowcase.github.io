...
import { canDeleteChatMessage, formatChatTime } from "@/lib/format";
...
export function ChatPanel({
  ...
  return (
    /* w-60 on laptops, w-72 from 1280px — at laptop widths (1024–1279)
    ...
    >
      ...
      >
        ...
        {messages.map((msg) => {
          ...
          const canDelete = canDeleteChatMessage(myRole, mine);
          return (
            <div
              key={msg._id}
