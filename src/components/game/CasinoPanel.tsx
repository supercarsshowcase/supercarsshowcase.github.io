...
const CASINO_PRIZE_CARS = [
  { id: "casino-infinity", brand: "One-off", name: "Infinity One Casino", value: 1000000000, rarity: "ultimate" as const, chance: 0.002 },
  { id: "casino-crystal", brand: "One-off", name: "Crystal Edition Casino", value: 500000000, rarity: "ultimate" as const, chance: 0.003 },
  { id: "casino-boat-tail", brand: "Rolls-Royce", name: "Boat Tail Casino Edition", value: 200000000, rarity: "ultimate" as const, chance: 0.005 },
  { id: "casino-noire", brand: "Bugatti", name: "La Voiture Noire Casino", value: 100000000, rarity: "ultimate" as const, chance: 0.008 },
  { id: "casino-imola", brand: "Pagani", name: "Imola Casino Edition", value: 65000000, rarity: "mythic" as const, chance: 0.015 },
  { id: "casino-jesko", brand: "Koenigsegg", name: "Jesko Absolut Casino", value: 48000000, rarity: "mythic" as const, chance: 0.012 },
  { id: "casino-tourbillon", brand: "Bugatti", name: "Tourbillon Casino Edition", value: 42000000, rarity: "mythic" as const, chance: 0.018 },
  { id: "casino-sian", brand: "Lamborghini", name: "Sián Casino Special", value: 35000000, rarity: "mythic" as const, chance: 0.022 },
  { id: "casino-chiron-super", brand: "Bugatti", name: "Chiron Super Sport Casino", value: 30000000, rarity: "mythic" as const, chance: 0.025 },
  { id: "casino-chiron", brand: "Bugatti", name: "Chiron Casino Edition", value: 25000000, rarity: "mythic" as const, chance: 0.03 },
  { id: "casino-nevera", brand: "Rimac", name: "Nevera Casino Edition", value: 22000000, rarity: "mythic" as const, chance: 0.03 },
  { id: "casino-agera", brand: "Koenigsegg", name: "Agera RS Casino", value: 18000000, rarity: "mythic" as const, chance: 0.035 },
  { id: "casino-revuelto", brand: "Lamborghini", name: "Revuelto Casino Edition", value: 12500000, rarity: "hyper" as const, chance: 0.05 },
  { id: "casino-812", brand: "Ferrari", name: "812 Casino Special", value: 12000000, rarity: "hyper" as const, chance: 0.06 },
  { id: "casino-daytona", brand: "Ferrari", name: "Daytona SP3 Casino", value: 10000000, rarity: "hyper" as const, chance: 0.06 },
  { id: "casino-one", brand: "Mercedes-AMG", name: "Project ONE Casino", value: 9000000, rarity: "hyper" as const, chance: 0.06 },
  { id: "casino-veneno", brand: "Lamborghini", name: "Veneno Casino Edition", value: 8400000, rarity: "hyper" as const, chance: 0.06 },
  { id: "casino-765lt", brand: "McLaren", name: "765LT Casino Edition", value: 8000000, rarity: "exotic" as const, chance: 0.07 },
  { id: "casino-p1", brand: "McLaren", name: "P1 Casino Edition", value: 5500000, rarity: "hyper" as const, chance: 0.07 },
  { id: "casino-laferrari", brand: "Ferrari", name: "LaFerrari Casino", value: 5200000, rarity: "hyper" as const, chance: 0.07 },
  { id: "casino-veyron", brand: "Bugatti", name: "Veyron Casino Edition", value: 4500000, rarity: "hyper" as const, chance: 0.07 },
  { id: "casino-918", brand: "Porsche", name: "918 Spyder Casino", value: 3200000, rarity: "exotic" as const, chance: 0.08 },
  { id: "casino-gt-black", brand: "Mercedes-AMG", name: "GT Black Series Casino", value: 2000000, rarity: "legendary" as const, chance: 0.10 },
  { id: "casino-huracan", brand: "Lamborghini", name: "Huracán Casino Edition", value: 1500000, rarity: "legendary" as const, chance: 0.10 },
  { id: "casino-911-gt3", brand: "Porsche", name: "911 GT3 RS Casino", value: 1200000, rarity: "legendary" as const, chance: 0.12 },
  { id: "casino-f458", brand: "Ferrari", name: "458 Italia Casino", value: 900000, rarity: "legendary" as const, chance: 0.14 },
  { id: "casino-r8", brand: "Audi", name: "R8 V10 Casino Edition", value: 750000, rarity: "legendary" as const, chance: 0.14 },
  { id: "casino-720s", brand: "McLaren", name: "720S Casino Edition", value: 650000, rarity: "exotic" as const, chance: 0.16 },
  { id: "casino-vantage", brand: "Aston Martin", name: "Vantage Casino Edition", value: 500000, rarity: "legendary" as const, chance: 0.16 },
  { id: "casino-amg-gt", brand: "Mercedes-AMG", name: "AMG GT Casino Edition", value: 400000, rarity: "legendary" as const, chance: 0.20 },
];
...
function CoinflipGame({ state, dispatch }: { state: GameState; dispatch: React.Dispatch<Action> }) {
  ...
  const play = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (mode === "cash") {
        if (wonGame) { dispatch({ type: "ADD_CASH", amount: bet }); }
        else { dispatch({ type: "ADD_CASH", amount: -bet }); }
      } else {
        if (wonGame) {
...
function RouletteGame({ state, dispatch }: { state: GameState; dispatch: React.Dispatch<Action> }) {
  ...
  const spin = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      else if (b.kind === "range") { if (b.value === "1-18" && num >= 1 && num <= 18) { wonGame = true; multiplier = 2; } if (b.value === "19-36" && num >= 19) { wonGame = true; multiplier = 2; } if (b.value === "1st" && num >= 1 && num <= 12) { wonGame = true; multiplier = 3; } if (b.value === "2nd" && num >= 13 && num <= 24) { wonGame = true; multiplier = 3; } if (b.value === "3rd" && num >= 25 && num <= 36) { wonGame = true; multiplier = 3; } }
      setWon(wonGame); const winAmt = wonGame ? bet * multiplier : 0; setWinAmount(winAmt);
      if (wonGame) { dispatch({ type: "ADD_CASH", amount: winAmt }); } setSpinning(false);
    }, 2500);
...
function CrashGame({ state, dispatch }: { state: GameState; dispatch: React.Dispatch<Action> }) {
  ...
  const cashOut = useCallback(() => {
    if (!playing || crashed) return; if (timerRef.current) clearInterval(timerRef.current);
    const win = Math.floor(bet * multiplier); dispatch({ type: "ADD_CASH", amount: win }); setCashedOut(true); setCashedAt(multiplier); setPlaying(false);
...
function JackpotGame({ state, dispatch }: { state: GameState; dispatch: React.Dispatch<Action> }) {
  ...
  const draw = useCallback(() => {
    ...
    setTimeout(() => { const playerWins = Math.random() < 0.4; if (playerWins) { dispatch({ type: "ADD_CASH", amount: totalPool }); setWinner("YOU WON THE JACKPOT!"); } else { setWinner("House wins the jackpot"); } setPool([]); setSpinning(false); }, 3000);
